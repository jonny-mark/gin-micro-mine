...
// doesn't go through the normal gRPC flow (creating a gRPC client vehicle.) then it will be up to the passed in
...
var (
	pattern_Greeter_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"api", "hello", "name"}, "", runtime.AssumeColonVerbOpt(true)))
)
